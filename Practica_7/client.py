...
def run():
    ...
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        getproducto_request = shop_pb2.GetProductoRequest(producto_id="123")
        getproducto_response = stub.GetProducto(getproducto_request)
        print("Respuesta de la solicitud:", getproducto_response.message)
        print("Solicitando producto:", getproducto_response.name, " ", getproducto_response.price, " ", getproducto_response.descripcion)
